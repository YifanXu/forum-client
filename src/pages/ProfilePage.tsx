	...
	return (
		<div className="ProfilePage">
			<div className="profileHeader">
				<div className="headerBand">
					...
					<div>
						...
						<div className="statNumber">214</div>
					</div>
					<div>
						<div className="statHeader">Joined</div>
						<div className="statNumber">Feb. 2</div>
					</div>
					<div>
			...
			<Row className="profieMain">
				<Col sm={12} md={5} lg={3} className="profileSideColumn">
				...
				<Col sm={12} md={7} lg={9} className="profileMainColumn">
